...
userprofile_df = pd.read_csv('Task2/Data/task2_userprofile.csv')
trading_volume_df = pd.read_csv('Task2/Data/task2_trading_volume.csv')
entities_mapping_df = pd.read_csv('Task2/Data/task2_entities_mapping.csv')
